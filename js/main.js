...
function cambiarTexto(elementoId) {
  const elementoTexto = document.getElementById(elementoId);
  let indiceTexto = 0;
  ...
  actualizarTexto(); // Cambiar al primer texto al cargar la página
  setInterval(actualizarTexto, intervalo); // Cambiar automáticamente cada 'intervalo' ms
}

// Llamadas a la función para dos elementos con diferentes IDs
cambiarTexto("texto-cambiante");
cambiarTexto("texto-cambiante2");
